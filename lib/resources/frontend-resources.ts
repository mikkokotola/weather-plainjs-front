...
export class FrontendResources {
    ...
    private createS3Bucket(): IBucket {
        return new Bucket(this.scope, 'weather-plainjs-app-frontend-bucket', {
            bucketName: 'weather-plainjs-app-frontend-bucket-2024-03-17',
    ...
    private deployS3Bucket(s3Bucket: IBucket) {
        new BucketDeployment(this.scope, 'deploy-plainjs-weather-app-frontend', {
            sources: [Source.asset('./lib/frontend-code')],
    ...
    private createCfnDistribution(s3Origin: S3Origin): Distribution {
        return new Distribution(this.scope, 'weatherfront-plainjs-app-cfn-distribution', {
            defaultBehavior: {
                origin: s3Origin,
